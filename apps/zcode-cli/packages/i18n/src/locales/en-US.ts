...
`,
  ...
  tui: {
    ...
    retiredAccountCommand:
      "Account login has been removed. Configure a provider in provider_config.json, then use /model.",
    modelSetupRequired: {
      help: "Configure your provider in provider_config.json, then use /model to select a model.",
