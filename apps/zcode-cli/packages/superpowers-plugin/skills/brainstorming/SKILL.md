...
*This skill is from `obra/superpowers` (https://github.com/obra/superpowers,
MIT License, Copyright (c) 2025 Jesse Vincent), redistributed with
attribution; see the plugin `NOTICE.md` for the full notice and provenance.*
