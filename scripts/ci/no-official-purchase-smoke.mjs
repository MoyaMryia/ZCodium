...
try {
  ...
  console.log(
    "Purchase removal walkthrough passed: model setup action, usage menu cancellation, zh/en narrow/wide; no purchase controls, embedded payment pages or external requests.",
  );
} finally {
  await browser?.close();
