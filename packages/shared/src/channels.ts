...
export const PlatformChannels = {
  ...
  /** 资源管理器「存储」tab：开始扫描本机 .zcodium 占用（main 持有 StorageService，Worker 线程遍历） */
  ...
  ReportDiagnostic: "zcode:report-diagnostic",
...
export interface PlatformChannelMap {
  [PlatformChannels.ReportDiagnostic]: {
    request: import("./diagnostics.js").DiagnosticRecordInput;
    response: void;
  };
  [PlatformChannels.ReportRendererHeapSample]: { request: RendererHeapSample; response: void };
