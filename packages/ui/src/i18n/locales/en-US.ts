...
const enUS: Record<string, string> = {
  ...
  "conversationShare.export.fileName": "File name",
  "conversationShare.export.note":
    "The file includes the selected conversation and available attachments. Review sensitive content before sending it to others.",
  "conversationShare.export.downloadStarted": "Download started",
  "conversationShare.trigger": "Export conversation",
  "conversationShare.shareTitle": "Title",
  "conversationShare.openLink": "Open share page",
  "conversationShare.result.title": "File saved",
  "conversationShare.result.description": "You can keep this file or send it to someone else.",
  "conversationShare.result.dismiss": "Close export result",
  "conversationShare.generatingLink": "Exporting conversation",
  "conversationShare.copyLink": "Copy link",
  "conversationShare.copySucceeded": "Copied",
  "conversationShare.publishSucceeded": "Conversation file saved",
  ...
  "conversationShare.warning.summary": "{count} files were omitted from the export.",
  ...
  "conversationShare.partial.preflightDeferred":
    "Some files could not be checked yet. They will be checked again during export.",
  "conversationShare.partial.continueWithSkips": "Continue (skip {count} file(s))",
  "conversationShare.partial.selectionHint":
    "Confirm the title, then save the selected content as a file.",
  "conversationShare.partial.confirmationTitle": "Export selected conversation",
  "conversationShare.publish.failedTitle": "Export failed",
  "conversationShare.publish.failedDescription": "Fix the issue below, then retry.",
  "conversationShare.publish.retry": "Retry export",
  "conversationShare.publish.footerMeta": "Exporting {selected} conversation turns",
  "conversationShare.publish.failedFooter": "Your selection and title are preserved",
  ...
  "conversationShare.partial.confirm": "Save file…",
  "conversationShare.partial.publishing": "Exporting…",
  "conversationShare.progress.collecting": "Collecting conversation and artifacts…",
  "conversationShare.progress.packing": "Creating the conversation file…",
  "conversationShare.progress.saving": "Preparing to save. Complete any open save dialog…",
  "conversationShare.progress.collectingFailed": "Collecting conversation and artifacts failed",
  "conversationShare.progress.packingFailed": "Could not create the conversation file",
  "conversationShare.progress.savingFailed": "Could not save the file",
  "conversationShare.phase.collecting": "Prepare content",
  "conversationShare.phase.packing": "Create file",
  "conversationShare.phase.saving": "Save file",
  "conversationShare.phase.collectingComplete": "Conversation and artifacts ready",
  "conversationShare.phase.packingComplete": "File ready",
  "conversationShare.phase.packingActive": "Packaging attachments",
  "conversationShare.phase.collectingPending": "Waiting to start",
  "conversationShare.phase.packingPending": "Waiting for preparation",
  "conversationShare.phase.savingPending": "Waiting for the file",
  ...
  "usage.error.stats.generic": "Unable to read local usage records. Try refreshing.",
  ...
  "automations.description": "Schedule recurring tasks for your projects.",
  ...
  "cuaPermission.modal.requestButton": "Request Permissions",
  "cuaPermission.modal.requesting": "Requesting permissions…",
