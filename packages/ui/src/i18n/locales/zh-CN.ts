...
const zhCN: Record<string, string> = {
  ...
  "common.saving": "保存中...",
  "common.delete": "删除",
  "conversationShare.export.fileName": "文件名",
  "conversationShare.export.note":
    "文件包含所选对话及可用附件。发送给别人前，请检查其中的敏感内容。",
  "conversationShare.export.downloadStarted": "已开始下载",
  "conversationShare.trigger": "导出对话",
  "conversationShare.shareTitle": "标题",
  "conversationShare.openLink": "打开分享页",
  "conversationShare.result.title": "文件已保存",
  "conversationShare.result.description": "可以将此文件留档或发送给别人。",
  "conversationShare.result.dismiss": "关闭导出结果",
  "conversationShare.generatingLink": "正在导出对话",
  "conversationShare.copyLink": "复制链接",
  "conversationShare.copySucceeded": "已复制",
  "conversationShare.publishSucceeded": "对话文件已保存",
  ...
  "conversationShare.warning.summary": "有 {count} 个文件未包含在导出中。",
  ...
  "conversationShare.partial.preflightDeferred": "部分文件暂时无法检查，导出时会再次确认。",
  "conversationShare.partial.continueWithSkips": "继续下一步（将跳过 {count} 个文件）",
  "conversationShare.partial.selectionHint": "确认标题后，将所选内容保存为文件。",
  "conversationShare.partial.confirmationTitle": "导出所选对话",
  "conversationShare.publish.failedTitle": "导出失败",
  "conversationShare.publish.failedDescription": "请根据下方提示修正后重试。",
  "conversationShare.publish.retry": "重试导出",
  "conversationShare.publish.footerMeta": "导出 {selected} 个对话轮次",
  "conversationShare.publish.failedFooter": "选择和标题已保留",
  ...
  "conversationShare.partial.confirm": "保存文件…",
  "conversationShare.partial.publishing": "导出中…",
  "conversationShare.progress.collecting": "正在整理会话和产物…",
  "conversationShare.progress.packing": "正在生成对话文件…",
  "conversationShare.progress.saving": "正在准备保存，请完成保存窗口中的操作…",
  "conversationShare.progress.collectingFailed": "整理会话和产物失败",
  "conversationShare.progress.packingFailed": "生成对话文件失败",
  "conversationShare.progress.savingFailed": "保存文件失败",
  "conversationShare.phase.collecting": "整理内容",
  "conversationShare.phase.packing": "生成文件",
  "conversationShare.phase.saving": "保存文件",
  "conversationShare.phase.collectingComplete": "会话和产物已准备",
  "conversationShare.phase.packingComplete": "文件已准备好",
  "conversationShare.phase.packingActive": "正在打包附件",
  "conversationShare.phase.collectingPending": "等待开始",
  "conversationShare.phase.packingPending": "等待整理完成",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 ZCodium 3.x 后开始计时。",
  ...
  "settings.modelProvider.modelCatalog.dialogTitle": "选择要添加的模型",
  "settings.modelProvider.modelCatalog.dialogDescription":
    "已从 {provider} 的接口读取到以下模型，勾选后添加。",
  "settings.modelProvider.modelCatalog.loading": "正在获取模型列表…",
  "settings.modelProvider.modelCatalog.empty": "该接口没有返回可用模型，请手动添加。",
  "settings.modelProvider.modelCatalog.alreadyAdded": "已添加",
  "settings.modelProvider.modelCatalog.failed": "获取模型列表失败：{reason}",
  "settings.modelProvider.modelCatalog.partialFailure": "已添加 {added} 个模型，{failed} 个失败。",
  "settings.modelProvider.modelCatalog.confirm": "添加所选（{count}）",
  "settings.modelProvider.modelCatalog.reason.provider-unavailable": "该供应商当前不可用",
  "settings.modelProvider.modelCatalog.reason.unsupported-access": "仅支持 API Key 类型的供应商",
  "settings.modelProvider.modelCatalog.reason.base-url-missing": "请先填写 Base URL",
  "settings.modelProvider.modelCatalog.reason.api-key-missing": "请先填写 API Key",
  "settings.modelProvider.modelCatalog.reason.request-failed": "接口请求失败",
  "settings.modelProvider.modelCatalog.reason.empty-catalog": "接口未返回可用模型",
  ...
  "settings.modelProvider.connectionsTitle": "模型连接",
  "settings.modelProvider.loadFailed": "无法读取模型配置，请重试。",
  "settings.modelProvider.refreshFailed": "刷新失败，当前配置已保留。",
  "settings.modelProvider.deleteFailed": "删除失败，连接已保留。",
  ...
  "usage.error.stats.generic": "无法读取本地用量记录，请刷新重试。",
  ...
  "chat.error.noAvailableModel": "请先配置一个可用模型。",
  ...
  "chat.error.copy.summaryLine": "报错摘要：{message}",
  "chat.error.copy.detail": "报错详情",
  "chat.error.copy.traceId": "TraceID: {traceId}",
  "chat.error.copy.heading": "ZCodium 报错信息",
  // 表单通用
  ...
  "automations.description": "为项目创建定时任务。",
  ...
  "automations.keepAwakeBanner": "ZCodium 运行会话时保持电脑唤醒。",
  ...
  "cuaPermission.modal.requestButton": "申请权限",
  "cuaPermission.modal.requesting": "正在申请权限…",
  "cuaPermission.modal.requestFailed": "无法申请权限：{error}",
